...
from sqlalchemy import Column, Integer, String, BigInteger, Index, Text, ForeignKey, DateTime
...
class Internship(Base):
    ...
    __table_args__ = (Index("Internship_companyId_idx", "companyId"),)
...
class Company(Base):
    ...
    __table_args__ = (Index("Company_name_key", "name", unique=True),)
